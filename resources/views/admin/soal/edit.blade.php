	...
	<div class="card-body">
		{!! Form::open(['action' => ['SoalController@update' , $soal->id] , 'method' => 'POST' , 'enctype' => 'multipart/form-data']) !!}
			...
			<div class="form-group">
				...
				<br>					
				{{Form::select('subkategori' , ['Kat1' => 'Sub-Kategori 1' , 'Kat2' => 'Sub-Kategori 2' , 'Kat3' => 'Sub-Kategori 3' , 'Kat4' => 'Sub-Kategori 4' , 'Kat5' => 'Sub-Kategori 5'] , $soal->subkategori , array('class' => 'btn btn-light dropdown-toggle'))}}
			</div>
			<div class="form-group">
				{{Form::label('kesulitan' , 'Kesulitan')}}
				<br>					
				{{Form::select('kesulitan' , ['Mudah' => 'Mudah' , 'Sedang' => 'Sedang' , 'Sulit' => 'Sulit'] , $soal->kesulitan , array('class' => 'btn btn-light dropdown-toggle'))}}
			</div>
			<div class="form-group">
			...
			<div class="container">
			  <div class="row">
			    <div class="col">
			    	...
			    	{{Form::text('opsi1' , $soal->opsi1 , ['class' => 'form-control' , 'placeholder' => 'Jawaban A' , 'required'])}}
			    </div>
			    <div class="col">
			    	{{Form::label('opsi2' , 'Pilihan Jawaban B')}}
			    	{{Form::text('opsi2' , $soal->opsi2,['class' => 'form-control' , 'placeholder' => 'Jawaban B' , 'required'])}}
			    </div>
			    <div class="w-100">
			    	<br>
			    </div>
			    <div class="col">
			    	...
			    	{{Form::text('opsi3' , $soal->opsi3 , ['class' => 'form-control' , 'placeholder' => 'Jawaban C' , 'required'])}}
			    </div>
			    <div class="col">
			    	{{Form::label('opsi4' , 'Pilihan Jawaban D')}}
			    	{{Form::text('opsi4' , $soal->opsi4 , ['class' => 'form-control' , 'placeholder' => 'Jawaban D' , 'required'])}}
			    </div>
			  </div>
			  <br>
			  <center>
			  	<div class="col-6">
			    	...
			    	{{Form::text('opsi5' , $soal->opsi5 , ['class' => 'form-control' , 'placeholder' => 'Jawaban E' , 'required'])}}
			    </div>
			  </center>
			</div>
			<br>
			...
			<div class="form-group">
				<div class="col-6">
			    	...
			    	{{Form::text('jawaban' , $soal->jawaban , ['class' => 'form-control' , 'placeholder' => 'Ketik jawaban yang benar' , 'required'])}}
			    </div>
			</div>
			</center>
			<center>
